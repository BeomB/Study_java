package Paymethod;
 ...
 public enum Paymethod {
        ...
        C000("VISA", "VISA 영어","VISA 일본","VISA 중국어","VISA 대만","VISA 태국"),
        C001("MASTER", "MASTER 영어","MASTER 일본","MASTER 중국어","MASTER 대만","MASTER 태국"),
        C002("AMEX", "AMEX 영어","AMEX 일본","AMEX 중국어","AMEX 대만","AMEX 태국"),
        C003("JCB", "JCB 영어","JCB 일본","JCB 중국어","JCB 대만","JCB 태국"),
        C004("DINERS", "DINERS 영어","DINERS 일본","DINERS 중국어","DINERS 대만","DINERS 태국"),
        C005("DISCOVER", "DISCOVER 영어","DISCOVER 일본","DISCOVER 중국어","DISCOVER 대만","DISCOVER 태국"),
        C007("MIR", "MIR 영어","MIR 일본","MIR 중국어","MIR 대만","MIR 태국"),
        C010("Alipay", "Alipay 영어","Alipay 일본","Alipay 중국어","Alipay 대만","Alipay 태국"),
        C015("PayPal", "PayPal 영어","PayPal 일본","PayPal 중국어","PayPal 대만","PayPal 태국"),
        C020("Tenpay", "Tenpay 영어","Tenpay 일본","Tenpay 중국어","Tenpay 대만","Tenpay 태국"),
        C023("UnionPay", "UnionPay 영어","UnionPay 일본","UnionPay 중국어","UnionPay 대만","UnionPay 태국"),
